...
:: Dont uncomment these since this is the STARTUP batch file. ...Unless you want to use /start the same way /restart works.
:: I may later add a check in here to see if the server is running, and if it is, then just exit.
